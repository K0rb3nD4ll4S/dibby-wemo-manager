...
**Windows:**
- **`Dibby Wemo Manager Setup 2.0.36.exe`** — NSIS installer (recommended)
- **`Dibby Wemo Manager 2.0.36.exe`** — Portable single-file executable

**macOS (universal — Intel + Apple Silicon):**
- **`Dibby Wemo Manager-2.0.36.dmg`** — Drag to Applications
...
**Linux (x64):**
- **`Dibby Wemo Manager-2.0.36.AppImage`** — Universal AppImage, runs anywhere
- **`dibby-wemo-manager_2.0.36_amd64.deb`** — Debian / Ubuntu
- **`dibby-wemo-manager-2.0.36.x86_64.rpm`** — Fedora / RHEL
...
| File | OS | Description |
|---|---|---|
| `Dibby Wemo Manager Setup 2.0.36.exe` | Windows | NSIS installer (recommended) |
| `Dibby Wemo Manager 2.0.36.exe` | Windows | Portable executable |
| `Dibby Wemo Manager-2.0.36.AppImage` | Linux x64 | Universal AppImage |
| `dibby-wemo-manager_2.0.36_amd64.deb` | Linux x64 | Debian / Ubuntu package |
| `dibby-wemo-manager-2.0.36.x86_64.rpm` | Linux x64 | Fedora / RHEL package |
| `Dibby Wemo Manager-2.0.36-arm64.AppImage` | Linux ARM64 | Raspberry Pi 4/5 AppImage |
| `dibby-wemo-manager_2.0.36_arm64.deb` | Linux ARM64 | Raspberry Pi OS package |
| `homebridge-dibby-wemo-2.0.36.tgz` | Any | Homebridge plugin npm package |
